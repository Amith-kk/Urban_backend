...
exports.register= async(req,res)=>{
    ...
    if(existingAdmin){
        ...
        const responseAdmin = { email: newAdmin.email, role: newAdmin.role }; // Assuming role exists in schema
...
exports.login = async(req,res)=>{
    ...
    try {
        ...
        const responseAdmin = { email: existingAdmin.email, role: existingAdmin.role }; // Assuming role exists in schema
